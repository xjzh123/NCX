!function($zero, $this, $module_body) {
    "use strict";
    "undefined" != typeof window && "function" == typeof define && define.amd ?
        define($module_body) :
            "undefined" != typeof module && module.exports ?
                module.exports = $module_body() : $this.exports ?
                    $this.exports = $module_body() : $this.Fingerprint2 = $module_body()
}(0, this, function() {
    "use strict";
    var $hash1 = function(e, t) {
      ...
      , T = function(e) {
        ...
        e = $hash2(e, [4283543511, 3981806797]),
        e = m(e, [0, e[0] >>> 1]),
        e = $hash2(e, [3301882366, 444984403]),
        e = m(e, [0, e[0] >>> 1])
    }
      , $x64hash128 = function(e, t) {
        ...
        for (var a = (e = e || "").length % 16, n = e.length - a, r = [0, t], i = [0, t], o = [0, 0], l = [0, 0], s = [2277735313, 289559509], c = [1291169091, 658871167], u = 0; u < n; u += 16)
            ...
            r = f(r, 27),
            r = $hash1(r, i),
            r = $hash1($hash2(r, [0, 5]), [0, 1390208809]),
            l = $hash2(l, c),
            l = f(l, 33),
            l = $hash2(l, s),
            i = m(i, l),
            i = f(i, 31),
            i = $hash1(i, r),
            i = $hash1($hash2(i, [0, 5]), [0, 944331445]);
        switch (o = [0, 0],
        l = [0, 0],
        a) {
        case 15:
      ...
      , $map = function(e, n) {
        var r = [];
        return null == e ? r : Array.prototype.map && e.map === Array.prototype.map ? e.map(n) : ($forEach(e, function(e, t, a) {
            r.push(n(e, t, a))
        }),
        r)
    }
      ...
      , u = function(e) {
        for (var t = false, a = 0, n = e.plugins.sortPluginsFor.length; a < n; a++) {
      ...
      , $hardwareConcurrency = function(e) {
      ...
      , $canvas = function(e) {
        ...
        n.rect(2, 2, 6, 6),
        t.push("canvas winding:" + (false === n.isPointInPath(5, 5, "evenodd") ? "yes" : "no")),
      ...
      , $webGL = function() {
        ...
        o.vertexAttribPointer(n.vertexPosAttrib, t.itemSize, o.FLOAT, false, 0, 0),
        ...
        return o.getShaderPrecisionFormat && $forEach(["FLOAT", "INT"], function(i) {
            $forEach(["VERTEX", "FRAGMENT"], function(r) {
                $forEach(["HIGH", "MEDIUM", "LOW"], function(n) {
                    $forEach(["precision", "rangeMin", "rangeMax"], function(e) {
      ...
      , _ = function(t, e) {
        ...
        window.swfobject.embedSWF(e.fonts.swfPath, i, "1", "1", "9.0.0", false, o, {
      ...
      , $values = [{
        ...
        key: "canvas",
        getData: function(e, t) {
            I() ? e($canvas(t)) : e(t.NOT_AVAILABLE)
        }
    }, {
        key: "webgl",
        getData: function(e, t) {
            k() ? e($webGL()) : e(t.NOT_AVAILABLE)
        }
    }, {
        ...
        getData: function(e, t) {
            ...
            var a = document.getElementsByTagName("body")[0]
              ...
              , o = function(e) {
                for (var t = false, a = 0; a < u.length; a++)
        ...
        getData: function(a, e) {
            ...
            $forEach([["threshold", -50], ["knee", 40], ["ratio", 12], ["reduction", -20], ["attack", 0], ["release", .25]], function(e) {
    ...
    return U.get = function(a, n) {
        ...
        a.components = a.extraComponents.concat($values);
        var r = {
            data: [],
        ...
        U.get(i, function(e) {
            for (var t = [], a = 0; a < e.length; a++) {
                ...
                if (n.value === (i.NOT_AVAILABLE || "not available"))
                    ...
                    t.push({
                        key: "plugins",
                        value: $map(n.value, function(e) {
                            var t = $map(e[2], function(e) {
            ...
            var r = $x64hash128($map(t, function(e) {
                return e.value
            }).join("~~~"), 31);
            o(r, t)
        })
